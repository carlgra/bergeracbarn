<?php
	...
	*/
	...
	$email_to = "enquiries@bergeracbarn.com"; 			// Specify the email address you want to send the mail to.
	$email_subject = "Enquiry"; 	// Set the subject of your email.
	// Specify a page on your website to display a thankyou message when the mail is sent
	$thankyou_url = "http://www.bergeracbarn.com/thankyou.html";
